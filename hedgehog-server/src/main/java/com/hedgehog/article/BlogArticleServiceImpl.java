...
import com.hedgehog.category.BlogCategory;
...
import com.hedgehog.like.BlogLikeService;
import com.hedgehog.tag.BlogTag;
...
public class BlogArticleServiceImpl extends ServiceImpl<BlogArticleMapper, BlogArticle> implements BlogArticleService {
    ...
    private void enrichArticles(List<BlogArticle> articles) {
        ...
        if (!authorIds.isEmpty()) {
            ...
            authorMap = users.stream().collect(Collectors.toMap(User::getId, u -> u));
        }
